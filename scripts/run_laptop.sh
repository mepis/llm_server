...
CUDA_SCALE_LAUNCH_QUEUES=4x GGML_CUDA_FORCE_MMQ=true GGML_CUDA_ENABLE_UNIFIED_MEMORY=1 ./llama-server -hf $model --port 3000 --host 100.120.235.11 -c 65536 -ngl 99 -b 1024 -ub 512 -ctk q4_0 --threads $threads --temp 0.7 --repeat-penalty 1.0 --presence-penalty 1.5 --top-p 0.8 --min-p 0.0 --flash-attn 0 --reasoning-budget 0 --cont-batching --kv-unified
