...
git pull
rm -r build
cmake -B build -DGGML_CUDA=ON -DBUILD_SHARED_LIBS=OFF -DGGML_NATIVE=OFF -DCMAKE_CUDA_ARCHITECTURES="86;89;120" -DGGML_CUDA_FORCE_MMQ=1 -DGGML_CUDA_PEER_MAX_BATCH_SIZE=256
