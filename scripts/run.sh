...
LLAMA_CACHE=$modelDir GGML_CUDA_FORCE_MMQ=true GGML_CUDA_ENABLE_UNIFIED_MEMORY=1 ${LLAMA_SERVER_BIN} -m "${MODELS_DIR}$model" --port 3000 --host 100.115.205.84 -c 262144 -ngl 99 --split-mode layer --tensor-split 16,12,12 --main-gpu 0 --temp 0.6 --top-p 0.95 --cont-batching --prio 3 --min_p 0.01 