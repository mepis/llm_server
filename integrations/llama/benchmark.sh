...
./llama-bench -m $MODEL_DIR/$MODEL -ngl 999 --split-mode $splitMode --tensor-split $tensorSplit --main-gpu $mainGpu --batch-size $batch_size --ubatch-size $ubatch_size --threads $threads --mlock --mmap 0 --swa-full 1 --fit on --fit-target 512 --fit-ctx 262144 --cont-batching --parallel 6 --sequences 2
