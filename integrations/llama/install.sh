...
if [ "$choice" == "y" ]; then
  ...
  cmake -B build -DGGML_CCACHE= -DGGML_NATIVE=1 -DGGML_LTO=1 -DGGML_CUDA=1 -DGGML_CUDA_FA=1 -DGGML_CUDA_GRAPHS=1 -DGGML_CUDA_NCCL=1 -DGGML_CUDA_PEER_MAX_BATCH_SIZE=1024 -DGGML_CUDA_PEER_COPY=1 -DGGML_CUDA_FORCE_CUBLAS=1 -DGGML_CUDA_FP16=1 -DCMAKE_CUDA_ARCHITECTURES="86-real;90-real;120-real" -DGGML_CUDA_COMPRESSION_LEVEL=0
