...
const createTool = async (req, res) => {
  try {
    ...
    if (!name || !description || !parameters) return res.status(400).json({ success: false, error: 'Name, description, and parameters are required' });
...
module.exports = { createTool, getAccessibleTools, getTool, updateTool, deleteTool, callTool };
